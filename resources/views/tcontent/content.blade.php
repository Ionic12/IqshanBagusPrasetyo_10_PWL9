...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row justify-content-center align-items-center">
            <div class="card" style="width: 50rem; background-color: #202020;">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="{{ route('tcontent.store') }}" id="myForm">
                    @csrf
                    <div class="form-row">
        ...
        <td style="text-align: center">
            <form action="{{ route('tcontent.destroy',['tcontent'=>$td->id]) }}" method="POST">
                <a class="btn btn-primary" href="{{ route('tcontent.edit',$td->id) }}">Edit</a>
                @csrf
                @method('DELETE')
