...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row justify-content-center align-items-center">
            <div class="card" style="width: 50rem; background-color: #202020;">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="{{ route('gcontent.store') }}" id="myForm">
                    @csrf
                    <div class="form-row">
        ...
        <td style="text-align: center">
            <form action="{{ route('gcontent.destroy',['gcontent'=>$rd->id]) }}" method="POST">
                <a class="btn btn-primary" href="{{ route('gcontent.edit',$rd->id) }}">Edit</a>
                @csrf
                @method('DELETE')
